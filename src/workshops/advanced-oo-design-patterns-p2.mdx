...
### This is part 2 of a 2-part workshop (see [Part 2](/workshops/part-2-advanced-object-oriented-design-patterns)).

_Students are expected to have attended part 1._
